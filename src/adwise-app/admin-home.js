...
`;
  ...
  _handleClick() {
    ...
    this.$.ajax._makeAjaxCall('get', `http://3.6.235.13:9090/adwise/slots?slotDate=${this.checkDate}`, null, 'availableSlots')
  }
  /**
  ...
  _handleView() {
    ...
    if (this.fromTime > this.toTime) {
      ...
      this.waiting = true;
      this.$.ajax._makeAjaxCall('get', `http://3.6.235.13:9090/adwise/plans?date=${this.date}&fromTime=${this.fromTime}&toTime=${this.toTime}`, null, 'ajaxResponse');
    }
  }
}
